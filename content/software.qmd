...
:::: {.columns}
::: {.column width=30%}
<img src="../images/logo-ncdeckr.png" width="80%" />
:::
::: {.column width=70%}
#### ncdeckr

The R package `ncdeckr` is a client to the [Nextcloud Deck API](https://deck.readthedocs.io/en/latest/API/). It is dedicated to manage (list, create, delete, update) boards, stacks, cards and labels.
:::
::::

{{< fa user >}} &nbsp;[Nicolas Casajus](https://nicolascasajus.fr) (maintainer)
<br/>
{{< fa globe >}} &nbsp;<https://frbcesab.github.io/ncdeckr>
<br/>
{{< fa brands github >}} &nbsp;<https://github.com/frbcesab/ncdeckr>
...
The R package `codebergr` is a client to query (GET, POST, DELETE, PUT methods) the Codeberg [API](https://codeberg.org/api/swagger).
:::
::::

{{< fa user >}} &nbsp;[Nicolas Casajus](https://nicolascasajus.fr) (maintainer)
<br/>
{{< fa globe >}} &nbsp;<https://frbcesab.github.io/codebergr>
<br/>
{{< fa brands github >}} &nbsp;<https://github.com/frbcesab/codebergr>
...
:::: {.columns}
::: {.column width=30%}
<img src="../images/logo-fairpub.png" width="80%" />
:::
::: {.column width=70%}
#### fairpub

The goal of the R package `fairpub` is to provide a user-friendly way to compute the non-profit and academic friendly ratio of the bibliographic reference list.
:::
::::
